...
def image_object_detect(prompt, detail_level, image):
...
def extract_summary(response: str,prompt_summary: str):
    """
    ...
    # Prepare the prompt for the Azure OpenAI chat completion
    # prompt = (
    #     f"{prompt_summary}:\n"
...
def process_images(prompt_img, detail_level, images, logfile_path,prompt_summary):
    times = []
    ...
    for i, image in enumerate(images):
        ...
        response = image_object_detect(prompt_img, detail_level, encoded_image)
        end_time = time.time()
        ...
        summary, tags = extract_summary(response, prompt_summary)
...
def main():
    ...
    process_images(prompt_img_content, detail_level, images, logfile_path ,prompt_text_summary)
